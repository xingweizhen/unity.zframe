    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            v2f vert(appdata_t v)
            {
                ...
                OUT.roundedArgs = float3(v.texcoord1.x, v.texcoord1.y, v.texcoord2.x);
                return OUT;
            }
            ...
            {
                float w = IN.roundedArgs.x;
                float h = IN.roundedArgs.y;
                float r = IN.roundedArgs.z;

                float alpha = AlphaForRoundedCorners(IN.texcoord, w, h, r);
