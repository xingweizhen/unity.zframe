...
namespace ZFrame.Tween
{
    public interface ITweenKit
    {
        ...
        object TweenRange(Renderer self, float from, float to, float duration, string propertyName);
        ...
        object TweenVector(Renderer self, Vector4 from, Vector4 to, float duration, string propertyName);
        object TweenColor(Graphic self, Color from, Color to, float duration);
        object TweenColor(Renderer self, Color from, Color to, float duration, string propertyName);        
