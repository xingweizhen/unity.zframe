	...
	public sealed class Encoder
	{
		...
		void EncodeObject(object value)
		{
			...
			foreach (var field in fields) {
				...
				if (fieldValue == null && Attribute.GetCustomAttributes(field).Any(attr => attr is SkipIfNull)) continue;
				if (Attribute.GetCustomAttributes(field).Any(attr => attr is Skip)) continue;
